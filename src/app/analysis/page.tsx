        ...
        <header className="flex justify-between items-start">
          <div>
            ...
            <p className="text-2xl md:text-3xl font-serif text-rosevia-charcoal tracking-tight font-light mt-1">
              Weekly Selfie <span className="italic text-rosevia-gold font-normal">Skin Scan</span>
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-start">
          ...
          <div className="md:col-span-5 glass-card p-5 space-y-4 flex flex-col items-center shadow-sm">
              ...
              {image ? (
                ...
                <div className="w-full h-full p-6 flex flex-col items-center justify-center space-y-4 bg-gradient-to-b from-[#111C18]/60 to-[#060D0B] relative">
                  ...
                  <div className="space-y-1 z-10">
                    <p className="text-xs font-bold text-rosevia-gold tracking-wider uppercase">Biological Diagnostics</p>
                    <p className="text-[9px] text-rosevia-clay leading-relaxed max-w-[200px] font-semibold mx-auto">
            ...
            <div className="w-full flex flex-col space-y-2 pt-2">
              <label className="w-full py-3.5 rounded-xl border border-dashed border-rosevia-rose bg-rosevia-cream/65 hover:bg-rosevia-rose/10 transition-all text-xs tracking-widest font-bold uppercase text-rosevia-clay text-center cursor-pointer block shadow-xs">
                <input 
                  type="file" 
                  accept="image/*" 
              ...
              {image && !scanning && (
                <button
                  ...
                  className="w-full py-4 rounded-xl bg-rosevia-gold text-rosevia-cream text-xs tracking-widest font-bold uppercase hover:bg-rosevia-rose transition-all cursor-pointer flex items-center justify-center shadow-md transform hover:-translate-y-0.5"
                >
            ...
            {showReport ? (
              <div className="space-y-5 animate-fade-in">
                ...
                <div className="glass-card p-6 flex items-center gap-6 shadow-sm">
                  ...
                  <div className="relative shrink-0 w-24 h-24 flex items-center justify-center">
                    ...
                    <div className="flex flex-col items-center justify-center z-10 mt-1">
                      <span className="text-3xl font-serif font-bold text-rosevia-gold leading-none">84</span>
                      <span className="text-[8px] font-bold text-rosevia-clay uppercase tracking-widest mt-1">Index</span>
                    </div>
                  </div>
                  ...
                  <div className="space-y-1.5 flex-1">
                    ...
                    <h3 className="text-base font-serif font-bold text-rosevia-gold">Clinical Diagnosis</h3>
                ...
                <div className="glass-card p-6 space-y-4 shadow-sm">
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      { label: "Epidermal Texture (Smoothness)", score: 81, color: "bg-rosevia-gold" },
                      { label: "Pore Congestion (Sebum Balance)", score: 78, color: "bg-rosevia-clay" },
                      { label: "Deep Cellular Hydration", score: 85, color: "bg-rosevia-sage" },
                      ...
                      <div key={idx} className="space-y-1.5">
                        <div className="flex justify-between text-xs font-bold text-rosevia-clay">
                          ...
                          <span className="text-rosevia-gold">{item.score}%</span>
                        </div>
                ...
                <div className="glass-card p-6 space-y-3.5 shadow-sm">
                  ...
                  <div className="flex justify-between items-center text-center bg-rosevia-cream border border-rosevia-rose/20 rounded-2xl p-5 shadow-xs">
                    <div>
                    ...
                    <div>
                      <p className="text-[9px] tracking-wider uppercase font-bold text-rosevia-gold">Current (May 26)</p>
                      <p className="text-sm font-bold text-rosevia-gold mt-1">84 Index</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="glass-card p-8 text-center flex flex-col items-center justify-center space-y-4 aspect-[4/3] md:aspect-[4/2.5] shadow-sm bg-rosevia-sand/70">
                <div className="w-12 h-12 rounded-full bg-rosevia-rose/25 flex items-center justify-center border border-rosevia-gold/30">
                  <Camera size={22} className="text-rosevia-gold animate-pulse" />
                </div>
                <h3 className="text-sm font-serif font-bold text-rosevia-gold uppercase tracking-wide">Provide a photo to activate diagnostics</h3>
                <p className="text-xs text-rosevia-clay max-w-sm leading-relaxed font-semibold">
